...
CREATE TABLE `tb_case` (
  ...
  PRIMARY KEY (`case_id`),
  CONSTRAINT `check_pic_id` FOREIGN KEY (`check_pic_id`) REFERENCES `tb_picnvideo` (`picnvideo_id`),
  CONSTRAINT `diagnose_pic_id` FOREIGN KEY (`diagnose_pic_id`) REFERENCES `tb_picnvideo` (`picnvideo_id`),
  CONSTRAINT `treat_video` FOREIGN KEY (`treat_video`) REFERENCES `tb_picnvideo` (`picnvideo_id`),
