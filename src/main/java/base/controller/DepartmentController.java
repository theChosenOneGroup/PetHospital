...
//  public ResponseWrapper ofCategory(@RequestParam String category) {
//    return responsePacker.pack(
//        JsonUtil.toMap("category", category),
//        () -> {
//          Department department = new Department();
//          department.setCategory(category);
//          return departmentDao.departmentOfCategory(department);
//        });
//  }
//
//  @GetMapping("/department/categorylist")
//  public ResponseWrapper categoryList() {
//    return responsePacker.pack(null, () -> departmentDao.categoryList());
//  }
//}
